...
import net.fractalpixel.ancienttech.utils.MathUtils.bigDecimalRoundingMathContext
...
fun Int.round(significantDigits: Int): Int {
    var value = this
    if (significantDigits <= 0) throw IllegalArgumentException("The parameter significantDigits should be positive, but it was $significantDigits")
